...
- 2026-06-04 - `PRAGMA foreign_keys=OFF; CREATE TABLE logs_new (...); INSERT INTO logs_new ... SELECT ..., CASE WHEN alert_resolution = 'unread' THEN NULL ELSE alert_resolution END ...; DROP TABLE logs; ALTER TABLE logs_new RENAME TO logs;` - Made alert_resolution column in logs table nullable and set default to NULL.
